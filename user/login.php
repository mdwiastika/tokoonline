                        ...
                        <div class="container card shadow overflow-hidden p-5 m-auto" style="width: 100%;">
                            ...
                            <form action="" method="POST">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="password" class="form-control" id="myPassword" name="password" style="display: inline-block; width: 90%;">
                                    <i class="fa fa-eye" style="display: inline; margin-left: 10px; font-size: larger;" onclick="myFunction()"></i>
                                </div>
                                <div class="form-group">
